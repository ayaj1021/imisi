...
class AppStyles {
  static final TextStyle h5 =
      GoogleFonts.inter(fontSize: 23, fontWeight: FontWeight.bold);
  ...
  static final TextStyle agTitle3Bold =
      GoogleFonts.inter(fontSize: 19, fontWeight: FontWeight.bold);
  static final TextStyle bodyRegularText =
      GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.normal);
        static final TextStyle captionText =
      GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.normal);
      static final TextStyle captionTextBold =
